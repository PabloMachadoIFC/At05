<?php
    ...
    switch ($aviso) {
        case 'Cadastrado':
            $msg = "Quadrado Cadastrado!";
            alert($msg);
            break;
        case 'NaoCadastrado':
            $msg = "Quadrado Não Cadastrado!";
            alert($msg);
            break;
        case 'Excluido':
            $msg = "Quadrado Excluido!";
            alert($msg);
            break;
        case 'NaoExcluido':
            $msg = "Quadrado Não Excluido!";
            alert($msg);
            break;
        case 'Editado':
            $msg = "Quadrado Editado!";
            alert($msg);
            break;
        case 'NaoEditado':
            $msg = "Quadrado Não Editado!";
            alert($msg);
            break;
        default:
            # code...
                ...
                <form action="acao.php" method="post">
                    <div class="row">                       
                        ...
                        <div class="col-3">
                            ...
                            <input type="text" name="lado" id="lado" class="form-control" value="<?php if($qeditando) echo $qeditando->getLado(); ?>">
                        </div>
                        <div class="col-3">
                        ...
                        <div class="col-12" style="margin-top: 1vh;">
                            <center>
                                <button type="submit" class="btn btn-primary" name="acao" value="salvar"><?= ($qeditando) ? 'Editar Quadrado' : 'Criar Quadrado'; ?></button>
                            </center>
                        </div>
                    </div>
                </form>
